...
export function SettingsTab({
  ...
  return (
    <div className="max-w-lg space-y-6">
      <div>
        <Label className="text-xs text-muted-foreground">{t("common.avatar", "Avatar")}</Label>
      ...
      <div>
        <Label className="text-xs text-muted-foreground">{t("agents.maxConcurrentTasks", "Max Concurrent Tasks")}</Label>
        <Input
          type="number"
          min={1}
          max={50}
